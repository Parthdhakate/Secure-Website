...
<body data-vide-bg="Peoples">
    <section id="wrapper">
                <div id="signin">
                    ...
                    <form action="regis.php" method="POST" enctype="multipart/form-data" class="signin-form">                    
                        ...
                        <input type='password' name="password" class='text-input' placeholder='Password' required></i>
                        <input type='password' name="cpassword" class='text-input' placeholder='Confirm Password' required></i>
                        <input type='date' class='text-input' id="birthday" name="Bday" placeholder='date' required>
                        <select class='text-input' placeholder='Country' name="Country">
                                ...
                                <option value="['Bolivia, Plurinational State of','BO']">Bolivia</option>
                                <option value="['Bonaire, Sint Eustatius and Saba','BQ']">Bonaire</option>
                                ...
                                <option value="['Congo, the Democratic Republic of the','CD']">Congo</option>
                                ...
                                <option value="['Korea, Democratic People's Republic of','KP']">Korea, Democratic People's</option>
                                ...
                                <option value="['Micronesia, Federated States of','FM']">Micronesia</option>
                                ...
                                <option value="['Venezuela, Bolivarian Republic of','VE']">Venezuela</option>
                        ...
                        <i class ="field button">
                        <input type="submit" name="submit" class="primary-btn"></button></i>       
                    </form>
                    <div class="links" style="padding-bottom: 100px;">
